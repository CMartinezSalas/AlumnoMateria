...
namespace DL
{
    ...
    public partial class ControlEscolarEntities : DbContext
    {
        ...
        public virtual ObjectResult<MateriasGetAsignadas_Result1> MateriasGetAsignadas(Nullable<int> idAlumno)
        {
            var idAlumnoParameter = idAlumno.HasValue ?
                new ObjectParameter("IdAlumno", idAlumno) :
                new ObjectParameter("IdAlumno", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MateriasGetAsignadas_Result1>("MateriasGetAsignadas", idAlumnoParameter);
        }
